...
default_extra_label = [(182305696, 453, 'No label', 'NoL'), 
               ...
               (484682464, 997, 'No label', 'NoL'),
               (549009216, 997, 'No label', 'NoL'),
               (560581568, 997, 'No label', 'NoL'),
               (563807424, 997, 'No label', 'NoL'),
               (576073728, 997, 'No label', 'NoL'),
               (589508416, 997, 'No label', 'NoL'),
               (589508480, 997, 'No label', 'NoL'),
               (599626944, 997, 'No label', 'NoL'),
               (606826624, 997, 'No label', 'NoL'),
               (606826688, 997, 'No label', 'NoL'),
               (607344832, 997, 'No label', 'NoL'),
               (614454272, 997, 'No label', 'NoL')
               ];
...
def prepare_annotation_files(slicing = None, orientation = None, 
  ...
  vol_annotation_file : str or None
    The annotation file for volume transform.
  ...
  if annotation_file is None:
    annotation_file = default_annotation_file;
  if vol_annotation_file is None:
